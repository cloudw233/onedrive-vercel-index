...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'haoye_qwq@3qqcsr.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/cloudw233',
    },
    {
      name: 'Mail',
      link: 'haoye_qwq@3qqcsr.onmicrosoft.com',
    },
  ],
